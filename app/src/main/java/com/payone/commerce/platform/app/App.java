        ...
        private void runCheckoutWithPaymentExecution(String commerceCaseMerchantReference)
                ...
                PaymentExecutionRequest paymentExecutionRequest = new PaymentExecutionRequest()
                                .paymentExecutionSpecificInput(new PaymentExecutionSpecificInput()
                                                .paymentReferences(new References().merchantReference(
                                                                "p-" + commerceCaseMerchantReference))
                                                .amountOfMoney(new AmountOfMoney()
                                                                .amount(3599L)
                                                                .currencyCode("EUR")))
                                .paymentMethodSpecificInput(new PaymentMethodSpecificInput()
                                                .sepaDirectDebitPaymentMethodSpecificInput(
                                                                new SepaDirectDebitPaymentMethodSpecificInput()
                                                                                .paymentProductId(new PaymentProductId(
                                                                                                771))
                                                                                                ...
                                                                                                new SepaDirectDebitPaymentProduct771SpecificInput()
                                                                                                                .mandate(new ProcessingMandateInformation()
                                                                                                                                ...
                                                                                                                                .uniqueMandateReference(
                                                                                                                                                "m-" + commerceCaseMerchantReference)
        ...
        private void runSingleStepCheckout(String commerceCaseMerchantReference)
                ...
                OrderRequest orderRequest = new OrderRequest()
                                .orderReferences(new References()
                                                .merchantReference("o-" + commerceCaseMerchantReference))
                                .paymentMethodSpecificInput(new PaymentMethodSpecificInput()
                                                .sepaDirectDebitPaymentMethodSpecificInput(
                                                                new SepaDirectDebitPaymentMethodSpecificInput()
                                                                                .paymentProductId(new PaymentProductId(
                                ...
                                .checkout(new CreateCheckoutRequest()
                                                .shoppingCart(new ShoppingCartInput()
                                                                .items(Arrays.asList(new CartItemInput()
                                                                                ...
                                                                                .orderLineDetails(
                                                                                                new OrderLineDetailsInput()
                                                                                                                .productCode("shelley-42")
                                                                                                                .productPrice(1999L)
                                                                                                                .quantity(1L)
                                                                                                                .productType(ProductType.GOODS)
                                                                                                                .taxAmount(19L))))));
                CreateCommerceCaseResponse initialCommerceCase = this.commerceCaseClient.createCommerceCaseRequest(
                                MERCHANT_ID,
                                createCommerceCaseRequest);
                ...
                try {
                        ...
                        okhttp3.OkHttpClient clientSpecificClient = new okhttp3.OkHttpClient.Builder()
                                        ...
                                        .addInterceptor(chain -> {
                                                ...
                                                okhttp3.Response response = chain.proceed(request);
                                                System.out.println("Checkout API Client response status: "
                                                                + response.code());
                                                return response;
                                        })
                                        .build();
                        ...
                        System.out.println(
                                        "Making request with checkout API client (using client-specific HTTP client)");
