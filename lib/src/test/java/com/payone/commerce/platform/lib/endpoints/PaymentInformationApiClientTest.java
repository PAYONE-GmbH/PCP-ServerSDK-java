...
public class PaymentInformationApiClientTest {
    ...
    class GetPaymentInformationTests {
        @Test
        @DisplayName("given request was successful, then return response")
    ...
    @Nested
    @DisplayName("refundPaymentInformation")
    class RefundPaymentInformationTests {
        @Test
        @DisplayName("given request was successful, then return response")
        void refundPaymentInformationSuccessful() throws InvalidKeyException, ApiException, IOException {

            PaymentInformationApiClient paymentInformationApiClient = spy(
                    new PaymentInformationApiClient(TestConfig.COMMUNICATOR_CONFIGURATION));
            PaymentInformationRefundResponse expected = new PaymentInformationRefundResponse();
            Response response = ApiResponseMocks.createResponse(201, new PaymentInformationRefundResponse());
        ...
        @Test
        @DisplayName("given request was unsuccessful (400), then throw exception")
        void refundPaymentInformationUnsuccessful() throws InvalidKeyException, IOException {
        ...
        @Test
        @DisplayName("given request was unsuccessful (500) with empty body, then throw exception")
        void refundPaymentInformationUnsuccessful500() throws InvalidKeyException, IOException {
        ...
        @Test
        @DisplayName("given some params are null, then throw exception")
        void refundPaymentInformationNullParams() throws InvalidKeyException {
