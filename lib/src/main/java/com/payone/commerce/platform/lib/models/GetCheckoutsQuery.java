...
public class GetCheckoutsQuery implements QueryConfig {
    ...
    public Map<String, String> toQueryMap() {
      ...
      // TODO: collections to string
      // if (this.includePaymentProductId != null) {
      //   query.put("includePaymentProductId", this.includePaymentProductId);
      // }
      // if (this.includeCheckoutStatus != null) {
      //   query.put("includeCheckoutStatus", this.includeCheckoutStatus);
      // }
      // if (this.includeExtendedCheckoutStatus != null) {
      //   query.put("includeExtendedCheckoutStatus", this.includeExtendedCheckoutStatus);
      // }
      // if (this.includePaymentChannel != null) {
      //   query.put("includePaymentChannel", this.includePaymentChannel);
      // }
