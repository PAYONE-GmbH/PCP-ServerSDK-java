...
public class StatusOutput implements Serializable {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getPaymentStatus() != null) {
      try {
        joiner.add(String.format("%spaymentStatus%s=%s", prefix, suffix,
            URLEncoder.encode(String.valueOf(getPaymentStatus()), "UTF-8").replaceAll("\\+", "%20")));
    ...
    if (getIsModifiable() != null) {
      try {
        joiner.add(String.format("%sisModifiable%s=%s", prefix, suffix,
            URLEncoder.encode(String.valueOf(getIsModifiable()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getOpenAmount() != null) {
      try {
        joiner.add(String.format("%sopenAmount%s=%s", prefix, suffix,
            URLEncoder.encode(String.valueOf(getOpenAmount()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getCollectedAmount() != null) {
      try {
        joiner.add(String.format("%scollectedAmount%s=%s", prefix, suffix,
            URLEncoder.encode(String.valueOf(getCollectedAmount()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getCancelledAmount() != null) {
      try {
        joiner.add(String.format("%scancelledAmount%s=%s", prefix, suffix,
            URLEncoder.encode(String.valueOf(getCancelledAmount()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getRefundedAmount() != null) {
      try {
        joiner.add(String.format("%srefundedAmount%s=%s", prefix, suffix,
            URLEncoder.encode(String.valueOf(getRefundedAmount()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getChargebackAmount() != null) {
      try {
        joiner.add(String.format("%schargebackAmount%s=%s", prefix, suffix,
            URLEncoder.encode(String.valueOf(getChargebackAmount()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
