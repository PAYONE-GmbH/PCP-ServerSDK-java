...
public class CardRecurrenceDetails implements Serializable {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getRecurringPaymentSequenceIndicator() != null) {
      try {
        joiner.add(String.format("%srecurringPaymentSequenceIndicator%s=%s", prefix, suffix, URLEncoder
            .encode(String.valueOf(getRecurringPaymentSequenceIndicator()), "UTF-8").replaceAll("\\+", "%20")));
