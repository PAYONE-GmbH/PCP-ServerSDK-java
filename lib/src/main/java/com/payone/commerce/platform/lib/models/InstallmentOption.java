...
public class InstallmentOption implements Serializable {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getInstallmentOptionId() != null) {
      try {
        joiner.add(String.format("%sinstallmentOptionId%s=%s", prefix, suffix,
            URLEncoder.encode(String.valueOf(getInstallmentOptionId()), "UTF-8").replaceAll("\\+", "%20")));
    ...
    if (getNumberOfPayments() != null) {
      try {
        joiner.add(String.format("%snumberOfPayments%s=%s", prefix, suffix,
            URLEncoder.encode(String.valueOf(getNumberOfPayments()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getEffectiveInterestRate() != null) {
      try {
        joiner.add(String.format("%seffectiveInterestRate%s=%s", prefix, suffix,
            URLEncoder.encode(String.valueOf(getEffectiveInterestRate()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getNominalInterestRate() != null) {
      try {
        joiner.add(String.format("%snominalInterestRate%s=%s", prefix, suffix,
            URLEncoder.encode(String.valueOf(getNominalInterestRate()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getFirstRateDate() != null) {
      try {
        joiner.add(String.format("%sfirstRateDate%s=%s", prefix, suffix,
            URLEncoder.encode(String.valueOf(getFirstRateDate()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
