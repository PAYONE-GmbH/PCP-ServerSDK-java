...
public class PaymentProduct840CustomerAccount implements Serializable {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getCompanyName() != null) {
      try {
        joiner.add(String.format("%scompanyName%s=%s", prefix, suffix,
            URLEncoder.encode(String.valueOf(getCompanyName()), "UTF-8").replaceAll("\\+", "%20")));
    ...
    if (getPayerId() != null) {
      try {
        joiner.add(String.format("%spayerId%s=%s", prefix, suffix,
            URLEncoder.encode(String.valueOf(getPayerId()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
