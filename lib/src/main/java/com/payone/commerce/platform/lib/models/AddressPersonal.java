...
public class AddressPersonal implements Serializable {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getAdditionalInfo() != null) {
      try {
        joiner.add(String.format("%sadditionalInfo%s=%s", prefix, suffix,
            URLEncoder.encode(String.valueOf(getAdditionalInfo()), "UTF-8").replaceAll("\\+", "%20")));
    ...
    if (getCity() != null) {
      try {
        joiner.add(String.format("%scity%s=%s", prefix, suffix,
            URLEncoder.encode(String.valueOf(getCity()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getCountryCode() != null) {
      try {
        joiner.add(String.format("%scountryCode%s=%s", prefix, suffix,
            URLEncoder.encode(String.valueOf(getCountryCode()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getHouseNumber() != null) {
      try {
        joiner.add(String.format("%shouseNumber%s=%s", prefix, suffix,
            URLEncoder.encode(String.valueOf(getHouseNumber()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getStreet() != null) {
      try {
        joiner.add(String.format("%sstreet%s=%s", prefix, suffix,
            URLEncoder.encode(String.valueOf(getStreet()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getZip() != null) {
      try {
        joiner.add(String.format("%szip%s=%s", prefix, suffix,
            URLEncoder.encode(String.valueOf(getZip()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
