...
public class CardPaymentMethodSpecificInput implements Serializable {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getAuthorizationMode() != null) {
      try {
        joiner.add(String.format("%sauthorizationMode%s=%s", prefix, suffix,
            URLEncoder.encode(String.valueOf(getAuthorizationMode()), "UTF-8").replaceAll("\\+", "%20")));
    ...
    if (getTransactionChannel() != null) {
      try {
        joiner.add(String.format("%stransactionChannel%s=%s", prefix, suffix,
            URLEncoder.encode(String.valueOf(getTransactionChannel()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getUnscheduledCardOnFileRequestor() != null) {
      try {
        joiner.add(String.format("%sunscheduledCardOnFileRequestor%s=%s", prefix, suffix,
            URLEncoder.encode(String.valueOf(getUnscheduledCardOnFileRequestor()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getUnscheduledCardOnFileSequenceIndicator() != null) {
      try {
        joiner.add(String.format("%sunscheduledCardOnFileSequenceIndicator%s=%s", prefix, suffix, URLEncoder
            .encode(String.valueOf(getUnscheduledCardOnFileSequenceIndicator()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getReturnUrl() != null) {
      try {
        joiner.add(String.format("%sreturnUrl%s=%s", prefix, suffix,
            URLEncoder.encode(String.valueOf(getReturnUrl()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getCardOnFileRecurringFrequency() != null) {
      try {
        joiner.add(String.format("%scardOnFileRecurringFrequency%s=%s", prefix, suffix,
            URLEncoder.encode(String.valueOf(getCardOnFileRecurringFrequency()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getCardOnFileRecurringExpiration() != null) {
      try {
        joiner.add(String.format("%scardOnFileRecurringExpiration%s=%s", prefix, suffix,
            URLEncoder.encode(String.valueOf(getCardOnFileRecurringExpiration()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
