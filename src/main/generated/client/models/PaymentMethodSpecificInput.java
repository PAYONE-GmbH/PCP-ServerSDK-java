...
public class PaymentMethodSpecificInput implements Serializable {
  ...
  public PaymentMethodSpecificInput cardPaymentMethodSpecificInput(CardPaymentMethodSpecificInput cardPaymentMethodSpecificInput) {
  ...
  **/
  ...
  public PaymentMethodSpecificInput mobilePaymentMethodSpecificInput(MobilePaymentMethodSpecificInput mobilePaymentMethodSpecificInput) {
  ...
  **/
  ...
  public PaymentMethodSpecificInput redirectPaymentMethodSpecificInput(RedirectPaymentMethodSpecificInput redirectPaymentMethodSpecificInput) {
  ...
  **/
  ...
  public PaymentMethodSpecificInput sepaDirectDebitPaymentMethodSpecificInput(SepaDirectDebitPaymentMethodSpecificInput sepaDirectDebitPaymentMethodSpecificInput) {
  ...
  **/
  ...
  public PaymentMethodSpecificInput financingPaymentMethodSpecificInput(FinancingPaymentMethodSpecificInput financingPaymentMethodSpecificInput) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_FINANCING_PAYMENT_METHOD_SPECIFIC_INPUT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setFinancingPaymentMethodSpecificInput(FinancingPaymentMethodSpecificInput financingPaymentMethodSpecificInput) {
    this.financingPaymentMethodSpecificInput = financingPaymentMethodSpecificInput;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.cardPaymentMethodSpecificInput, paymentMethodSpecificInput.cardPaymentMethodSpecificInput) &&
        Objects.equals(this.mobilePaymentMethodSpecificInput, paymentMethodSpecificInput.mobilePaymentMethodSpecificInput) &&
        Objects.equals(this.redirectPaymentMethodSpecificInput, paymentMethodSpecificInput.redirectPaymentMethodSpecificInput) &&
        Objects.equals(this.sepaDirectDebitPaymentMethodSpecificInput, paymentMethodSpecificInput.sepaDirectDebitPaymentMethodSpecificInput) &&
        Objects.equals(this.financingPaymentMethodSpecificInput, paymentMethodSpecificInput.financingPaymentMethodSpecificInput) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(cardPaymentMethodSpecificInput, mobilePaymentMethodSpecificInput, redirectPaymentMethodSpecificInput, sepaDirectDebitPaymentMethodSpecificInput, financingPaymentMethodSpecificInput, customerDevice, paymentChannel);
  }
  ...
  public String toString() {
    ...
    sb.append("    cardPaymentMethodSpecificInput: ").append(toIndentedString(cardPaymentMethodSpecificInput)).append("\n");
    sb.append("    mobilePaymentMethodSpecificInput: ").append(toIndentedString(mobilePaymentMethodSpecificInput)).append("\n");
    sb.append("    redirectPaymentMethodSpecificInput: ").append(toIndentedString(redirectPaymentMethodSpecificInput)).append("\n");
    sb.append("    sepaDirectDebitPaymentMethodSpecificInput: ").append(toIndentedString(sepaDirectDebitPaymentMethodSpecificInput)).append("\n");
    sb.append("    financingPaymentMethodSpecificInput: ").append(toIndentedString(financingPaymentMethodSpecificInput)).append("\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getCardPaymentMethodSpecificInput() != null) {
      joiner.add(getCardPaymentMethodSpecificInput().toUrlQueryString(prefix + "cardPaymentMethodSpecificInput" + suffix));
    }

    // add `mobilePaymentMethodSpecificInput` to the URL query string
    if (getMobilePaymentMethodSpecificInput() != null) {
      joiner.add(getMobilePaymentMethodSpecificInput().toUrlQueryString(prefix + "mobilePaymentMethodSpecificInput" + suffix));
    }

    // add `redirectPaymentMethodSpecificInput` to the URL query string
    if (getRedirectPaymentMethodSpecificInput() != null) {
      joiner.add(getRedirectPaymentMethodSpecificInput().toUrlQueryString(prefix + "redirectPaymentMethodSpecificInput" + suffix));
    }
    ...
    if (getSepaDirectDebitPaymentMethodSpecificInput() != null) {
      joiner.add(getSepaDirectDebitPaymentMethodSpecificInput().toUrlQueryString(prefix + "sepaDirectDebitPaymentMethodSpecificInput" + suffix));
    }

    // add `financingPaymentMethodSpecificInput` to the URL query string
    if (getFinancingPaymentMethodSpecificInput() != null) {
      joiner.add(getFinancingPaymentMethodSpecificInput().toUrlQueryString(prefix + "financingPaymentMethodSpecificInput" + suffix));
    }
