...
public class RedirectPaymentMethodSpecificInput implements Serializable {
  ...
  **/
  ...
  public RedirectPaymentMethodSpecificInput paymentProduct840SpecificInput(RedirectPaymentProduct840SpecificInput paymentProduct840SpecificInput) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.requiresApproval, redirectPaymentMethodSpecificInput.requiresApproval) &&
        ...
        Objects.equals(this.paymentProduct840SpecificInput, redirectPaymentMethodSpecificInput.paymentProduct840SpecificInput) &&
        Objects.equals(this.redirectionData, redirectPaymentMethodSpecificInput.redirectionData);
  }

  @Override
  public int hashCode() {
    return Objects.hash(requiresApproval, paymentProcessingToken, reportingToken, tokenize, paymentProductId, paymentProduct840SpecificInput, redirectionData);
  }
  ...
  public String toString() {
    ...
    sb.append("    paymentProduct840SpecificInput: ").append(toIndentedString(paymentProduct840SpecificInput)).append("\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getTokenize() != null) {
      try {
        joiner.add(String.format("%stokenize%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getTokenize()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getPaymentProduct840SpecificInput() != null) {
      joiner.add(getPaymentProduct840SpecificInput().toUrlQueryString(prefix + "paymentProduct840SpecificInput" + suffix));
    }
