  ...
  **/
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getIsCancellable() != null) {
      try {
        joiner.add(String.format("%sisCancellable%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getIsCancellable()), "UTF-8").replaceAll("\\+", "%20")));
    ...
    if (getStatusCategory() != null) {
      try {
        joiner.add(String.format("%sstatusCategory%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getStatusCategory()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getIsAuthorized() != null) {
      try {
        joiner.add(String.format("%sisAuthorized%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getIsAuthorized()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getIsRefundable() != null) {
      try {
        joiner.add(String.format("%sisRefundable%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getIsRefundable()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
