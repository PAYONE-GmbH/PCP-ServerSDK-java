...
public class OrderLineDetailsResult implements Serializable {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, status, productCode, productPrice, productType, quantity, taxAmount, productUrl, productImageUrl, productCategoryPath, merchantShopDeliveryReference);
  }
