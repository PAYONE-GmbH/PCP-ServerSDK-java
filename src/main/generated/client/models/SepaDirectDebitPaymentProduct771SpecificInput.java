...
public class SepaDirectDebitPaymentProduct771SpecificInput implements Serializable {
  ...
  public SepaDirectDebitPaymentProduct771SpecificInput existingUniqueMandateReference(String existingUniqueMandateReference) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.existingUniqueMandateReference, sepaDirectDebitPaymentProduct771SpecificInput.existingUniqueMandateReference) &&
  ...
  public String toString() {
    ...
    sb.append("    existingUniqueMandateReference: ").append(toIndentedString(existingUniqueMandateReference)).append("\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getExistingUniqueMandateReference() != null) {
      try {
        joiner.add(String.format("%sexistingUniqueMandateReference%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getExistingUniqueMandateReference()), "UTF-8").replaceAll("\\+", "%20")));
