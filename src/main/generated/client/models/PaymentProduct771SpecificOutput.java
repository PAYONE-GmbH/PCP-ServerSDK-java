...
public class PaymentProduct771SpecificOutput implements Serializable {
  ...
  **/
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `mandateReference` to the URL query string
    if (getMandateReference() != null) {
      try {
        joiner.add(String.format("%smandateReference%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getMandateReference()), "UTF-8").replaceAll("\\+", "%20")));
